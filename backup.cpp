...
int intersectant(vect ray, vertex P, vertex A, vertex B, vertex C);
int intersectant(vect ray, vertex P, vertex A, vertex B, vertex C)
{
...
int main(int argc, char **argv)
{
    ...
    if (ray.x == 1)
        cout << "ray rayection: x" << endl;
    else if (ray.y == 1)
        cout << "ray rayection: y" << endl;
    else if (ray.z == 1)
        cout << "ray rayection: z" << endl;
    ...
    for (auto f : Face) // for each triangle
    {
        ...
        auto dotproduct = normal.x*ray.x + normal.y*ray.y + normal.z*ray.z;
            ...
            {   
                ...
                {                    
                    ...
                    if (pointList[i][j].size() > 1)
                    {
                        ...
                        {   
                            while (!((*pt).enter == false && (*pt).touchStart == false && (*pt).touchEnd == false && (*pt).exit == true
                            	  || (*pt).enter == false && (*pt).touchEnd == true  && (*pt).exit == true))
                            {
                                pt++;
